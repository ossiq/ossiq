...
```bash
uv run hatch run ossiq status --production testdata/pypi/version-constraint
```
...
```bash
uv run hatch run ossiq status testdata/pypi/yanked
```
...
```bash
uv run hatch run ossiq status <project-with-cves>
```
...
```bash
uv run hatch run ossiq status <project-with-prerelease-dep>
```
...
# With
uv run hatch run ossiq status --allow-prerelease testdata/pypi/version-constraint
```
...
```bash
uv run hatch run ossiq info requests testdata/pypi/version-constraint
```
...
```bash
uv run hatch run ossiq info this-package-does-not-exist testdata/pypi/version-constraint
```
...
```bash
uv run hatch run ossiq status testdata/pypi/pip-classic-library
```
