...
export function useD3Tree(options: UseD3TreeOptions) {
  ...
  function handleNodeSelect(d: TreeNode) {
    ...
    onNodeSelect({
      ...
      recommended_version: d.data.recommended_version,
      next_action: d.data.next_action,
      requires_constraint_widening: d.data.requires_constraint_widening,
      recommended_from_rung: d.data.recommended_from_rung,
      ...
      maintenance_risk: d.data.maintenance_risk,
      maintenance_state: d.data.maintenance_state,
