...
/**
 * Schema for OSS-IQ project metrics export data (v1.5 adds the health-score fields exposure_window_days, p_vuln, p_supplychain, impact, expected_exposure, fitness and gate to PackageMetrics and TransitivePackageMetrics, and declares update_transitive_impacts)
 */
...
export interface PackageMetrics {
  ...
  /**
   * Remediation window in days; null when it could not be computed
   */
  exposure_window_days?: number | null;
  /**
   * Probability of known-vulnerability exploitation over the exposure window
   */
  p_vuln?: number | null;
  /**
   * Probability of a supply-chain incident over the exposure window
   */
  p_supplychain?: number | null;
  /**
   * Blast-radius multiplier applied to the incident probability
   */
  impact?: number | null;
  /**
   * impact multiplied by the combined incident probability
   */
  expected_exposure?: number | null;
  /**
   * 0-100 presentation projection of expected_exposure (higher is healthier)
   */
  fitness?: number | null;
  /**
   * Deterministic pass/quarantine/block gate decision
   */
  gate?: GateInfo | null;
  [k: string]: unknown;
}
...
export interface GateInfo {
  /**
   * Gate verdict: pass, quarantine, or block
   */
...
export interface TransitivePackageMetrics {
  ...
  is_package_unpublished: boolean;
  /**
   * Remediation window in days; absent or null when it could not be computed
   */
  exposure_window_days?: number | null;
  /**
   * Probability of known-vulnerability exploitation over the exposure window
