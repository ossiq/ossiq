  ...
  function buildNode(key: string, versionDefinedOverride?: string): D3NodeData {
    ...
    if (vnode.directName !== null) {
      ...
      return {
        ...
        epss: de?.epss ?? null,
        stability_csi: de?.stability_csi ?? null,
        stability_coverage: de?.stability_coverage ?? null,
        stability_risk: de?.stability_risk ?? null,
    ...
    return {
      ...
      epss: re?.epss ?? null,
      stability_csi: re?.stability_csi ?? null,
      stability_coverage: re?.stability_coverage ?? null,
      stability_risk: re?.stability_risk ?? null,
