  ...
  function buildNode(key: string, versionDefinedOverride?: string): D3NodeData {
    ...
    if (vnode.directName !== null) {
      ...
      return {
        ...
        fitness: de?.fitness ?? null,
        expected_exposure: de?.expected_exposure ?? null,
        p_vuln: de?.p_vuln ?? null,
        p_supplychain: de?.p_supplychain ?? null,
        exposure_window_days: de?.exposure_window_days ?? null,
        impact: de?.impact ?? null,
        gate: de?.gate ?? null,
    ...
    return {
      ...
      fitness: re?.fitness ?? null,
      expected_exposure: re?.expected_exposure ?? null,
      p_vuln: re?.p_vuln ?? null,
      p_supplychain: re?.p_supplychain ?? null,
      exposure_window_days: re?.exposure_window_days ?? null,
      impact: re?.impact ?? null,
      gate: re?.gate ?? null,
