...
class TestBuildNpmFreezeArgs:
    ...
    def test_rewrite_versions_flag_included_when_set(self) -> None:
        ...
        assert "--rewrite-versions" in build_npm_freeze_args(options)
    ...
    def test_rewrite_versions_flag_absent_when_not_set(self) -> None:
        ...
        assert "--rewrite-versions" not in build_npm_freeze_args(options)
    ...
    def test_overrides_included(self) -> None:
        ...
        assert "--override lodash==4.17.21" in build_npm_freeze_args(options)
