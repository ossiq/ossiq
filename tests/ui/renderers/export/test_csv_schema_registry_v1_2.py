"""Tests for CSV export schema registry v1.2."""
...
class TestCsvSchemaRegistryV12(CsvSchemaRegistryBaseTest):
    version = ExportCsvSchemaVersion.V1_2
    ...
    def test_packages_schema_has_constraint_source_file_column(self, packages_schema):
        field_names = [f["name"] for f in packages_schema["fields"]]
        assert "constraint_source_file" in field_names
...
class TestCsvRendererV12(CsvExportRendererBaseTest):
    schema_version = "1.2"
