...
class TestVersionsDifference:
    ...
    def test_all_diff_types_mapping(self):
        ...
        assert VERSION_INVERSED_DIFF_TYPES_MAP[VERSION_DIFF_MAJOR] == "DIFF_MAJOR"
        assert VERSION_INVERSED_DIFF_TYPES_MAP[VERSION_DIFF_MINOR] == "DIFF_MINOR"
        assert VERSION_INVERSED_DIFF_TYPES_MAP[VERSION_DIFF_PATCH] == "DIFF_PATCH"
        assert VERSION_INVERSED_DIFF_TYPES_MAP[VERSION_DIFF_PRERELEASE] == "DIFF_PRERELEASE"
        assert VERSION_INVERSED_DIFF_TYPES_MAP[VERSION_DIFF_BUILD] == "DIFF_BUILD"
        assert VERSION_INVERSED_DIFF_TYPES_MAP[VERSION_NO_DIFF] == "NO_DIFF"
        assert VERSION_INVERSED_DIFF_TYPES_MAP[VERSION_LATEST] == "LATEST"
