"""
Pre-configured HTTP session for the OSV.dev CVE API with POST response caching.
"""
...
class OsvSession(requests_cache.CachedSession):
    """A pre-configured CachedSession for the OSV API.
